describe 'records' do
	...
	describe 'as a sinlgeton' do
		...
		it 'should not have an accessible new method' do
			expect{ Rbdigital::Records.new }.to raise_error(NoMethodError)
		end

		it 'should return the same object from instance method' do
			expect(Rbdigital::Records.instance).to be(Rbdigital::Records.instance)
		end
	...
	describe 'config' do
		...
		it 'should be able to get setttings hash' do
	      ...
	      "settings" => { "library_id" => 2389 }
			...
			records = Rbdigital::Records.instance
	...
	describe 'catalogue' do
	    ...
	    list = [
			...
			Rbdigital::Records.instance.save_catalogue(list)
